  ...
  const skillGroups = [
    {
      ...
      title: "Frontend",
      skills: ["React.js", "Next.js", "TypeScript", "Tailwind CSS", "HTML5", "CSS3", "Bootstrap", "Styled Components"],
    },
    {
              ...
              <div className="flex flex-col gap-3">
                {socialLinks.map(({ label, href, color, icon }) => (
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="flex items-center gap-4 glass rounded-2xl p-4 border border-white/5 hover:border-violet-500/30 transition-all duration-300 hover:-translate-y-1 group"
                  >
